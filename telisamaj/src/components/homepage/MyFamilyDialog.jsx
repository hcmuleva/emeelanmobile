      ...
      <div key={`${type}-${index}`} style={listItemStyle}>
        ...
        <Form.Item label="Business Location">
          <Input
            ...
            onChange={(val) =>
              updateMember(type, index, "businessLocation", val)
            }
          />
        </Form.Item>
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        >
          <Space wrap>
            <Radio value="parents" style={{ fontSize: 13 }}>
              Parent
            </Radio>
            <Radio value="siblings" style={{ fontSize: 13 }}>
              Sibling
            </Radio>
            <Radio value="maternal" style={{ fontSize: 13 }}>
              Maternal
            </Radio>
          </Space>
        </Radio.Group>
