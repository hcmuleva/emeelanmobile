...
import { GroupOutlined, UserSwitchOutlined } from '@ant-design/icons';
const REACT_APP_NAME= process.env.REACT_APP_NAME;
const messageItems = [
  {
    "title": "FirstTime",
    "text": "First time Teli Samaj have matrimonial App"
  },
  {
    "title": "Admins",
    "text": "350 plus admin to help you to get register profiles details and background verification"
  },
  {
    "title": "Invite",
    "text": "Invite option to find suitable profile and based on this other side person can accept or reject"
  },
  {
    "title": "OnlyFor TeliSamaj",
    "text": "This app is for only TeliSamaj and its approval reject based concept"
  },
  {
    "title": "HarishMuleva",
    "text": "Famous Social servent and well known in India for Social services for Dharm, Siksha, Gyan and Soch"
  }
]
// Custom styled Marquee component for donors
const DonorMarquee = ({ messageItems }) => {
  return (
    <div className="donor-marquee-container" style={{ 
      ...
      <div className="marquee-header" style={{ 
        ...
        <GroupOutlined color="#b00000" fontSize={18} />
        <span style={{ 
          marginLeft: '6px',
          fontWeight: 'bold',
          color: '#b00000'
 ...
 // const user = JSON.parse(localStorage.getItem("user"));
  ...
  return (
    <div style={{ padding: '16px' }}>
      <DonorMarquee messageItems={messageItems} />
