...
export default function ReferralRegistration({isLogined,setIsLogined}) {
  ...
  const payload={
     "username":"ddddd", "email":"ddddd@dd.com", "password":"ssddd", "orgid":orgId,"referralId":referralId

  }
  console.log("Referral:", referralId, "Org:", orgId);
  ...
  return (
    <div>
      ...
      <Button onClick={()=>{
        console.log("ORG ID", orgId, " Payload", payload)
        handleSubmit()
      }}>Submit</Button>
