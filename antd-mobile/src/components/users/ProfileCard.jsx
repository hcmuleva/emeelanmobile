...
export default function ProfileCard({user}) {
  ...
  return (
    <div>
        ...
        {fieldPairs.flatMap(pair => pair.map((field, idx) => (
            ...
            <div style={{ 
              ...
              <div style={{ fontSize: '14px' }}>
                {field.value || 'N/A'}
                 ...
                 <h5 style={{ margin: 0, fontSize: '20px' }}>{user.FirstName}-{user.FatherName?user.FatherName:user.LastName}{user.FatherName}</h5>
