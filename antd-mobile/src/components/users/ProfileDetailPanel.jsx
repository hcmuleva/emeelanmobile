...
const ProfileDetailPanel = ({ user }) => {
  ...
  const renderActions = () => {
    ...
    if (role === "SELF") {
      ...
      // Use basic HTML buttons for admin actions for maximum compatibility
      return (
        <div
          style={{
            display: "flex",
      ...
      <div style={{ flex: 1, overflowY: "auto" }}>
        ...
        >
          ...
          <div>
            ...
            {user?.status === "PENDING" && !actionTaken && (
              <Tag
                color={theme.accent}
                style={{
                  marginTop: "8px",
