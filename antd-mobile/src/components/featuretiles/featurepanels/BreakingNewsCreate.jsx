import { Form, Input, TextArea, Button, ImageUploader, Toast, Dialog } from "antd-mobile";
...
export default function BreakingNewsCreate() {
  ...
  const beforeUpload = (file) => {
    if (fileList.length >= MAX_IMAGES) {
      Toast.show({ icon: 'fail', content: `You can only upload up to ${MAX_IMAGES} image` });
      return null;
    }
  ...
  return (
    <div style={{ padding: 16, maxWidth: 600, margin: '0 auto' }}>
      <h2 style={{ fontSize: 24, fontWeight: 'bold', color: '#e53935', marginBottom: 24 }}>
