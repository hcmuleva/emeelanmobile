                ...
                <List.Item title="Father's Name">
                  {editMode ? (
                    <Input
                      ...
                      onChange={(val) =>
                        handleChange("family", "fatherName", val)
                      }
                    />
                  ) : (
                ...
                <List.Item title="Mother's Name">
                  {editMode ? (
                    <Input
                      ...
                      onChange={(val) =>
                        handleChange("family", "motherName", val)
                      }
                    />
                  ) : (
                ...
                <List.Item title="Highest Degree">
                  {editMode ? (
                    <Input
                      ...
                      onChange={(val) =>
                        handleChange("education", "degree", val)
                      }
                    />
                  ) : (
                ...
                <List.Item title="Institution">
                  {editMode ? (
                    <Input
                      ...
                      onChange={(val) =>
                        handleChange("education", "institution", val)
                      }
                    />
                  ) : (
                ...
                <List.Item title="Company">
                  {editMode ? (
                    <Input
                      ...
                      onChange={(val) =>
                        handleChange("profession", "company", val)
                      }
                    />
                  ) : (
                ...
                <List.Item title="Role">
                  {editMode ? (
                    <Input
                      ...
                      onChange={(val) =>
                        handleChange("profession", "role", val)
                      }
                    />
                  ) : (
                ...
                <List.Item title="Preferred Language">
                  {editMode ? (
                    <Input
                      ...
                      onChange={(val) =>
                        handleChange("mypreference", "language", val)
                      }
                    />
                  ) : (
                ...
                <List.Item title="Preferred Location">
                  {editMode ? (
                    <Input
                      ...
                      onChange={(val) =>
                        handleChange("mypreference", "location", val)
                      }
                    />
                  ) : (
                ...
                <List.Item title="Hobbies">
                  {editMode ? (
                    <Input
                      ...
                      onChange={(val) =>
                        handleChange("mydetail", "hobbies", val)
                      }
                    />
                  ) : (
                ...
                <List.Item title="Interests">
                  {editMode ? (
                    <Input
                      ...
                      onChange={(val) =>
                        handleChange("mydetail", "interests", val)
                      }
                    />
                  ) : (
                ...
                <List.Item title="Notification">
                  {editMode ? (
                    <Input
                      ...
                      onChange={(val) =>
                        handleChange("settings", "notification", val)
                      }
                    />
                  ) : (
                ...
                <List.Item title="Dark Mode">
                  {editMode ? (
                    <Input
                      ...
                      onChange={(val) =>
                        handleChange("settings", "darkMode", val)
                      }
                    />
                  ) : (
