          ...
          <Card title="Merchant Details">
            ...
            >
              ...
              <Form.Item
                label="Cause"
                name="cause"
                rules={[{ required: true, message: "Please enter Cause" }]}
              >
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please enter Created by fullname",
                  },
                ]}
              >
              ...
              <Form.Item
                ...
                label={
                  <>
                    <span style={{ color: "red" }}>*</span> Cast
                  </>
                }
                rules={[{ required: true, message: "Please select your Cast" }]}
              >
                <Radio.Group style={{ display: "flex", gap: "10px" }}>
                  <Radio value="SEERVI0002" style={{ marginRight: "15px" }}>
                    SEERVI
                  </Radio>
                  <Radio value="TELI0001" style={{ marginRight: "15px" }}>
                    TELI
                  </Radio>
              ...
              <Form.Item
                label="Default Amount (for fixed QR)"
                name="defaultAmount"
              >
          ...
          <Card title={isFixedAmount ? "Fixed Amount QR" : "Dynamic Amount QR"}>
            ...
            >
              ...
              <div style={verticalGap}>
                <Button block onClick={copyToClipboard}>
                  Copy UPI Link
                </Button>
                <Button block color="primary" onClick={downloadQR}>
                  Download QR Code
                </Button>
                <Button block color="primary" onClick={handleQrUpdate}>
                  Set Qr Code
                </Button>
                <Button block onClick={() => setMerchantData(null)}>
                  Reset Setup
                </Button>
              </div>
