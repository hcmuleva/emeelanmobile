...
import { Layout, Card, Form, Input, Button, DatePicker, Select, Tabs, Row, Col, Typography, Progress, notification, InputNumber, Space, Modal } from 'antd';
...
export const RegisterUser = ({open,onClose}) => {
