...
export default function EditProfile({ user }) {
  ...
  // User data matching ProfileCard
    ...
    <Card style={{ width: 600 }}>
      <Space direction="vertical" size="large" style={{ width: '100%' }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 16 }}>
          <Avatar src={user?.profilePicture?.formats?.
thumbnail?.url} size={64} />
        ...
        >
          <Tabs defaultActiveKey="personalInfo">
            ...
            <TabPane tab="Preferences" key="preferences">
              <Space direction="vertical" size="small" style={{ width: '100%' }}>
                <Form.Item name="PreMinAge" label="Preferred Minimum Age">
                  <Input placeholder="Enter Preferred Minimum Age" />
                </Form.Item>
                <Form.Item name="PreMaxAge" label="Preferred Maximum Age">
                  <Input placeholder="Enter Preferred Maximum Age" />
                </Form.Item>
                <Form.Item name="PreMinHeight" label="Preferred Minimum Height">
                  <Input placeholder="Enter Preferred Minimum Height" />
                </Form.Item>
                <Form.Item name="PreMaxHeight" label="Preferred Maximum Height">
                  <Input placeholder="Enter Preferred Maximum Height" />
                </Form.Item>
                <Form.Item name="PreDescription" label="Preferences Description">
                  <Input.TextArea placeholder="Enter Preferences Description" />
                </Form.Item>
              </Space>
            </TabPane>
          </Tabs>
