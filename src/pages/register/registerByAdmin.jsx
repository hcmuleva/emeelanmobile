...
import { Layout, Card, Form, Input, Button, DatePicker, Select, Tabs, Row, Col, Typography, Progress, notification, InputNumber, Space } from 'antd';
...
export const RegisterByAdminPage = ({ userrole, createdBy, setView }) => {
